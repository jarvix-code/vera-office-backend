  ...
  <q-page class="flex flex-center bg-grey-2">
    ...
    <div v-if="!cameraActive && !capturedImage && !uploading" class="full-width">
      ...
      >
        ...
        <q-tab name="usb" label="USB-Stick" icon="usb" />
      ...
      <q-tab-panels v-model="activeTab" animated>
        ...
        <!-- USB Tab -->
        <q-tab-panel name="usb" class="text-center q-pa-lg">
          <q-icon name="usb" size="64px" color="primary" class="q-mb-md" />
          <div class="text-h6 q-mb-md">USB-Stick Erfassung</div>
          <div class="text-body2 text-grey-7 q-mb-lg">
            Stecke einen USB-Stick ein. VERA erkennt automatisch neue Dokumente und verarbeitet sie.
          </div>
          <q-btn
            unelevated
            color="primary"
            icon="search"
            label="USB-Stick suchen"
            @click="scanUSB"
            :loading="usbScanning"
          />
          <div v-if="usbFiles.length > 0" class="q-mt-lg">
            <q-list bordered>
              <q-item v-for="file in usbFiles" :key="file.name">
                <q-item-section avatar>
