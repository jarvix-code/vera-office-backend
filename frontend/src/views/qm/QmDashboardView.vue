<template>
  <q-page class="q-pa-md">
    ...
    <!-- Quick Search Card -->
    <q-card flat bordered class="q-mb-lg" style="background: rgba(11, 170, 186, 0.07);">
      <q-card-section>
        <div class="row items-center">
          <div class="col">
            <div class="text-h6">🔍 QM-Dokumente durchsuchen</div>
            <div class="text-caption text-grey-7">Semantische Suche über alle QM-Dokumente</div>
          </div>
          <div class="col-auto">
            <q-btn
              unelevated
