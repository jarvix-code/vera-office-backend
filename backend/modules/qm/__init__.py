...
- 5 UI-Tabs in der Sidebar:
    📋 QM Übersicht → /qm/dashboard    (order 300)
    📖 QM-Handbuch  → /qm/handbook     (order 310)
    ✅ Audits       → /qm/audits       (order 320)
    🧹 Hygiene      → /qm/hygiene      (order 330)
    ✅ Compliance   → /qm/compliance   (order 340)
