...
class LicenseStore:
    ...
    def is_licensed(self, module: str) -> bool:
        ...
        TEMP FIX: Gibt immer True zurück (Admin-Testing!)
        TODO: Proper Admin Override + Crypto-Keys implementieren
        ...
        """
        # TEMP FIX: Always licensed (for admin testing)
        logger.debug(f"is_licensed({module}): TEMP FIX - returning True (admin bypass)")
        return True
