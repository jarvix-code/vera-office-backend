...
def main():
    ...
    if private_key_path.exists() or public_key_path.exists():
        logger.error("[ERROR] Schlüsselpaar existiert bereits!")
        ...
        logger.warning("[WARNING]  ACHTUNG: Alle bestehenden Lizenzschlüssel werden ungültig!")
        return
    ...
    logger.success(f"[OK] Private Key: {private_key_path}")
    logger.success(f"[OK] Public Key:  {public_key_path}")
    
    logger.warning("")
    logger.warning("[WARNING]  WICHTIG:")
