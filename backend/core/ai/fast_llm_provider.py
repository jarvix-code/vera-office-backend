# DEPRECATED – Nicht mehr aktiv. LLMRouter nutzt local_llm_provider.FastLLMProvider (Qwen lokal).
"""
DEPRECATED – Fast LLM Provider (Cloud-Version: OpenAI / Anthropic)

Der LLMRouter importiert FastLLMProvider aus local_llm_provider.py (Qwen lokal),
NICHT aus dieser Datei. Diese Datei bleibt als Referenz/Fallback für Cloud-Betrieb.

Voraussetzungen für Aktivierung:
- FAST_LLM_API_KEY gesetzt (ENV oder vera.yaml)
- internet_enabled: true in vera.yaml
- Kein lokales Qwen-GGUF vorhanden
