...
# -*- coding: utf-8 -*-
"""
SIMPLE LOOP PARSER - Process PDFs ONE BY ONE
Robust, no threading, saves after each PDF
"""
...
def extract_text(pdf_path):
    ...
    try:
        ...
        return ""  # Return empty for corrupt/unreadable PDFs
...
def main():
    print("=" * 60)
    print("SIMPLE LOOP PARSER - ONE BY ONE")
    print("=" * 60)
