...
async def submit_feedback(
    ...
    try:
        ...
        ticket_id = await _send_to_telegram(type, message, screenshot_path)
...
async def _send_to_telegram(feedback_type: str, message: str, screenshot_path: Optional[Path] = None) -> int:
    ...
    Args:
        feedback_type: Typ (bug, feature, question, other)
        message: Feedback-Text
        screenshot_path: Optional Screenshot-Pfad
    ...
    try:
        ...
        # Get Telegram Config (direkt aus yaml lesen, da nicht in Settings gemappt)
        ...
        # Get Chat-ID (Admin User)
        # TODO: Aus DB oder Config holen
        admin_chat_id = "7519975748"  # Boris' Telegram ID
        ...
        async with httpx.AsyncClient() as client:
            ...
            logger.success(f"✅ Feedback an Telegram gesendet")
            return 999  # Dummy Ticket-ID (TODO: Aus DB holen)
